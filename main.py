...
def clear():
    ...
    var = IntVar(root)
    var.set(0)
    sb1.config(textvariable=var), sb2.config(textvariable=var),sb3.config(textvariable=var), sb4.config(textvariable=var)
    sb5.config(textvariable=var), sb6.config(textvariable=var),sb7.config(textvariable=var), sb8.config(textvariable=var)
